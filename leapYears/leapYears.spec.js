...
describe('leapYears', function () {
  it('works with non century years4', function () {
    expect(leapYears(1996)).toEqual(true);
  });
  it('works with non century years5', function () {
  ...
  it('works with century years2', function () {
    expect(leapYears(1600)).toEqual(true);
  });
  it('works with century years3', function () {
